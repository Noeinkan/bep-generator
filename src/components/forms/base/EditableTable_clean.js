...
import { Users, Plus, X, Edit2, Sparkles, Maximize2 } from 'lucide-react';
...
const EditableTable = React.memo(({ field, value, onChange, error }) => {
  ...
  // Helper function to render table content (used both in normal view and fullscreen)
          ...
          <div className="flex items-center gap-2">
            ...
            {!isFullscreen && (
              <button
                ...
                className="flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg transition-all transform hover:scale-105 shadow-md"
